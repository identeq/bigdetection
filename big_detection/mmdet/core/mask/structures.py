...
class BitmapMasks(BaseInstanceMasks):
    ...
    def translate(self,
        ...
        Example:
            >>> from big_detection.mmdet import BitmapMasks
    ...
    def random(cls,
               ...
               dtype=np.uint8,
               rng=None):
        """Generate random bitmap masks for example / testing purposes.
...
class PolygonMasks(BaseInstanceMasks):
    ...
    def random(cls,
               ...
               dtype=np.float32,
               rng=None):
        """Generate random polygon masks for example / testing purposes.
