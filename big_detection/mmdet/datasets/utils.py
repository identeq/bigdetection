...
from big_detection.mmdet.datasets.pipelines.loading import LoadImageFromFile, LoadAnnotations
from big_detection.mmdet.models.dense_heads.ga_rpn_head import GARPNHead
